...
extension Cryptograph.Crypto.RIPEMD160 {
...
extension Cryptograph.Crypto.RIPEMD160 {
    ...
    public static func hash(message: Data?) -> Data {
        ...
        var md = Cryptograph.Crypto.RIPEMD160()
    ...
    public static func hash(message: String?) -> Data? {
        ...
        return Cryptograph.Crypto.RIPEMD160.hash(message: data)
    }
}
...
extension Cryptograph.Crypto.RIPEMD160 {
    ...
    public static func hmac(key: Data, message: Data) -> Data {
        ...
        var innerMd = Cryptograph.Crypto.RIPEMD160()
        innerMd.update(data: innerKeyPad)
        innerMd.update(data: message)
        var outerMd = Cryptograph.Crypto.RIPEMD160()
    ...
    public static func hmac(key: Data, message: String) -> Data {
        return Cryptograph.Crypto.RIPEMD160.hmac(key: key, message: message.data(using: .utf8)!)
    }
    
    public static func hmac(key: String, message: String) -> Data {
        return Cryptograph.Crypto.RIPEMD160.hmac(key: key.data(using: .utf8)!, message: message)
    }
}
